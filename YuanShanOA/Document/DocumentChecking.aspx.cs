...
{
    public partial class DocumentChecking1 : System.Web.UI.Page
    {
        ...
        private void gvDateBind()
        {
            ...
            gvDocumentTemplate.DataSource = new YunShanOA.BusinessLogic.DocumentManager.DocumentManager().getListByStatus(2);
        ...
        {
            YunShanOA.Workflow.DocumentWF.ReviewCheck info = new Workflow.DocumentWF.ReviewCheck();
            ...
            try
            {
                DocumentWorkFlowProcess.RunChecking(Guid.Parse(this.txtWFID.Text.ToString()), info);
                this.btnSubmit.Enabled = false;
                this.lbMsg.Text = "已经提交成功";
                gvDateBind();
            }
            catch (Exception)
            {
