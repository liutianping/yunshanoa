<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DocumentChecking.aspx.cs" Inherits="YunShanOA.Document.DocumentChecking1" %>
                            ...
                            <td>
                                <table cellpadding="10" style="width: 581px">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                          &nbsp;&nbsp<asp:RadioButton ID="rbtOK" runat="server" Checked="true" GroupName="GroupName" />通过
                                            &nbsp;
                                            <asp:RadioButton ID="rbtReject" runat="server" GroupName="GroupName" />不通过
                                            &nbsp;</td>
                                    </tr>
                                    <tr>
                                        <td class="style1">
                                            <asp:Button ID="btnSubmit" runat="server" Text="提交审批" 
